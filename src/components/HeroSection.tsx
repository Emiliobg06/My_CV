...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-white to-sky-50"
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
          I am a student in computer science interested in working in data
science/engineering. Passionate about the development of AI and
Machine Learning. I am currently looking for an intern job as a data
engineer.
        </p>
